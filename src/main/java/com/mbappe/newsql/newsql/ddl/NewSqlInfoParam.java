...
public class NewSqlInfoParam {
     ...
     * @mbg.generated
     */
    public NewSqlInfoParam appendOrderByClause(OrderCondition orderCondition, SortType sortType) {
     ...
     * @mbg.generated
     */
    public NewSqlInfoParam setPage(boolean page) {
        this.page = page;
        return this;
    }
     ...
     * @mbg.generated
     */
    public NewSqlInfoParam setPageSize(int pageSize) {
     ...
     * @mbg.generated
     */
    public NewSqlInfoParam setPageStart(int pageStart) {
